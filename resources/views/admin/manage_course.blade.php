        ...
        <div id="maincontainer" class="relative w-full text-black shadow-lg rounded-2xl">
            ...
            <div class="flex flex-col w-full text-black lg:flex-row lg:text-white">
                ...
                <div id="contentArea" class="w-full">
                    <div id="courseOverview" class="flex-row justify-between lg:flex ">
                        <div class="relative z-0 bg-black border border-gray-400 shadow-lg text-mainwhitebg lg:w-4/5 lg:py-8 lg:rounded-e-md">
