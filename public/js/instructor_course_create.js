$(document).ready(function() {
        ...
        lessons.forEach(function(lesson) {
            ...
            <tr class="border-b-2 border-black">
                                ...
                                <td class="flex items-center justify-between">
                                    <input class="edit_row" data-id="`+ lesson['id'] +`" type="text" disabled value="`+ lesson['lesson_name'] +`">
                                    <div class="">
                                        <button type="button" class="h-10 px-2 mx-2 my-10 font-medium rounded cursor-pointer bg-amber-400 edit-lesson" data-id="`+ lesson['id'] +`">Edit</button>
                                        <button type="button" class="hidden h-10 px-2 mx-2 my-10 font-medium rounded cursor-pointer bg-amber-400 delete-lesson" data-id="`+ lesson['id'] +`">Delete</button>
                                    </div>
                                </td>
                            </tr>
            `;
    ...
    $('#lesson_body').on('click', '.edit-lesson', function(e) {
        ...
        $(this).replaceWith('<button class="h-10 px-2 mx-2 my-10 font-medium rounded cursor-pointer bg-amber-400 save-lesson" data-id="' + lessonId + '">Save</button>');
    ...
    $('#lesson_body').on('click', '.save-lesson', function(e) {
        ...
        if (lessonIndex !== -1) {
            ...
            $(this).replaceWith('<button class="h-10 px-2 mx-2 my-10 font-medium rounded cursor-pointer bg-amber-400 edit-lesson" data-id="' + lessonId + '">Edit</button>');
        }
    });
