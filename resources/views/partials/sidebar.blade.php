...
<section class="fixed relative z-20 w-1/3 h-auto overflow-hidden text-black" id="sidebar_full">
    ...
    <div class="fixed flex flex-col justify-between w-4/5 px-5 border-r-4 bg-mainwhitebg md:h-screen md:pt-16 md:relative border-darthmouthgreen" id="instructorSidebar">
        ...
        <div class="">
            ...
            <ul class="flex flex-row justify-between mt-10 md:flex-col md:text-base">
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_performances hover:bg-darthmouthgreen group md:py-4">
                    <a class="flex items-center justify-center md:justify-start md:px-4" href="{{ url("/admin/performances") }}">
