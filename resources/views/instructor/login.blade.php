@include('partials.header')
    ...
    <section class="flex flex-row w-full h-screen text-sm ">
        ...
        <header class="fixed top-0 left-0 z-40 flex flex-row items-center w-full px-4 py-4 bg-transparent">
            <a href="#">
                <span class="self-center font-semibold font-semibbold whitespace-nowrap md:text-2xl text-seagreen">
                    Eskwela4EveryJuan
                </span>
            </a>
        </header>
        ...
        {{-- MAIN --}}
        <div class="relative w-full h-screen lg:overflow-auto text-darthmouthgreen md:flex md:justify-center md:items-center lg:w-1/2 lg:pt-24" id="loginForm">
                ...
                <form class="flex flex-col justify-center text-black rounded-lg md:mt-4 h-96 md:w-3/4 md:mx-auto lg:w-full" action="{{ url('/instructor/login') }}" method="POST">
                    ...
                    <div class="pb-4 mx-4 text-sm border-b-4">
                        ...
                        <div class="flex flex-col my-4 lg:flex-row lg:justify-between lg:items-center">
                            <label class="font-medium lg:w-1/2" for="instructor_username">Email or Username:</label>
                            <div class="relative lg:w-1/2">
                                ...
                                <input class="w-full h-8 pl-10 text-black rounded ring-2 md:h-10 lg:h-12 md:pl-12 ring-seagreen" type="text" name="instructor_username" id="instructor_username">
                            </div>
                            
                        </div>
                        
                        <div class="flex flex-col my-4 lg:flex-row lg:justify-between lg:items-center">
                            <label class="font-medium lg:w-1/2" for="instructor_password">Password:</label>
                            <div class="relative lg:w-1/2">
                                ...
                                <input class="w-full h-8 pl-10 text-black rounded ring-2 ring-seagreen md:h-10 lg:h-12 md:pl-12" type="password" name="password" id="password">
