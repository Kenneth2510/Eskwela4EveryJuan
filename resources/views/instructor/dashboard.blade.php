@include('partials.header')
    ...
    <section class="relative w-full h-auto bg-mainwhitebg">
        ...
        <section class="relative h-screen px-2 mx-auto overflow-auto">
            <div class="top-0 right-0 md:absolute z-1 md:w-3/4 pt-[110px] md:pt-[60px] ">
                ...
                <div class="px-4 py-8 mx-4 mt-4 mb-4 border-2 rounded-lg shadow-lg">
                    ...
                    <div class="flex flex-col mt-5 text-sm">
                        <div class="h-56 p-4 my-5 font-medium bg-teal-400 shadow-lg rounded-xl">
                        ...
                        <div class="flex flex-col my-5">
                            <div class="flex flex-col items-center my-1 shadow-lg bg-violet-400 rounded-xl">
                        ...
                        <div class="p-4 my-5 font-medium shadow-lg bg-sky-400 rounded-xl">
                            <h2 class="hidden text-xl">Number of Learners</h2>
