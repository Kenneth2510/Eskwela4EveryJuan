...
@section('content')
    ...
    <div id="deleteLessonContentModal" class="fixed top-0 left-0 z-50 flex items-center justify-center hidden w-screen h-screen bg-black bg-opacity-50">
    ...
    <div id="deleteLessonContentPictureModal" class="fixed top-0 left-0 z-50 flex items-center justify-center hidden w-screen h-screen bg-black bg-opacity-50">
        {{-- <form id="deleteCourse" action="" data-course-id="{{ $course->course_id }}"> --}}
            {{-- @csrf --}}
            <div class="p-5 text-center bg-white rounded-lg">
                <p>Are you sure you want to delete this content?</p>
    ...
    <div id="editLessonContentModal" class="fixed top-0 left-0 z-50 flex items-center justify-center hidden w-full h-full bg-gray-200 bg-opacity-75">
        <div class="modal-content bg-white p-4 rounded-lg shadow-lg w-[750px]">
            <div class="flex justify-end w-full">
    ...
    <div id="addLessonContentUrlModal" class="fixed top-0 left-0 z-50 flex items-center justify-center hidden w-full h-full bg-gray-200 bg-opacity-75">
        <div class="modal-content bg-white p-4 rounded-lg shadow-lg w-[750px]">
            <div class="flex justify-end w-full">
    ...
    <div id="addLessonContentModal" class="fixed top-0 z-50 flex items-center justify-center hidden w-full h-full py-8 bg-gray-200 bg-opacity-75">
        <div class="w-full h-full p-4 overflow-y-scroll bg-white rounded-lg shadow-lg modal-content md:w-3/5 overscroll-y-auto">
            <div class="flex justify-end w-full">
