...
<section class="w-screen h-screen relative flex">
    <div id="LoginLeft" class="w-1/2 h-full bg-neutral-200 relative">
        ...
        @csrf
            ...
            <div id="button" class="relative mt-3 w-4/5 mx-auto px-12 py-2 flex justify-between">
                ...
                <button type="submit" class="rounded-xl bg-green-700 text-white font-semibold text-xl py-3 px-7 hover:bg-green-900">Log in</button>
            </div>
        </form>
    ...
    <div id="LoginRight" class="w-1/2 h-full bg-seagreen relative right-0">
