    ...
    <section class="relative flex w-full h-screen text-sm">
        ...
        <div class="w-full h-screen bg-mainwhitebg text-darthmouthgreen md:bg-seagreen lg:w-1/2 lg:text-mainwhitebg lg:pt-24" id="loginForm">
            <div class="rounded-lg md:shadow-xl md:w-3/4 md:mx-auto md:bg-mainwhitebg lg:bg-opacity-0 lg:shadow-transparent">
                ...
                <form class="flex flex-col justify-center mt-10 text-black rounded-lg md:mt-4 h-96 md:w-3/4 md:mx-auto lg:w-full lg:text-mainwhitebg" action="{{ url('/instructor/login/process')}}" method="POST">
                    @csrf
                    <div class="pb-4 mx-4 text-sm border-b-4 md:text-base">
                        <div class="flex flex-col my-4 lg:flex-row lg:justify-between lg:items-center">
                            ...
                            <div class="relative">
                                ...
                                <input class="w-full h-8 pl-10 text-black rounded md:h-10 lg:h-12 md:pl-12 lg:w-96" type="email" name="instructor_email" id="instructorEmail">
                            </div>
                        ...
                        <div class="flex flex-col my-4 lg:flex-row lg:justify-between lg:items-center">
                            ...
                            <div class="relative">
                                ...
                                <svg class="absolute right-0 w-6 h-6 mx-1 top-1 md:w-8 md:h-8 md:top-2" id="showPwd" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M480-320q75 0 127.5-52.5T660-500q0-75-52.5-127.5T480-680q-75 0-127.5 52.5T300-500q0 75 52.5 127.5T480-320Zm0-72q-45 0-76.5-31.5T372-500q0-45 31.5-76.5T480-608q45 0 76.5 31.5T588-500q0 45-31.5 76.5T480-392Zm0 192q-146 0-266-81.5T40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200Zm0-300Zm0 220q113 0 207.5-59.5T832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280Z"/></svg>
                                <svg class="absolute right-0 hidden w-6 h-6 mx-1 top-1 md:w-8 md:h-8 md:top-2" id="hidePwd" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="m644-428-58-58q9-47-27-88t-93-32l-58-58q17-8 34.5-12t37.5-4q75 0 127.5 52.5T660-500q0 20-4 37.5T644-428Zm128 126-58-56q38-29 67.5-63.5T832-500q-50-101-143.5-160.5T480-720q-29 0-57 4t-55 12l-62-62q41-17 84-25.5t90-8.5q151 0 269 83.5T920-500q-23 59-60.5 109.5T772-302Zm20 246L624-222q-35 11-70.5 16.5T480-200q-151 0-269-83.5T40-500q21-53 53-98.5t73-81.5L56-792l56-56 736 736-56 56ZM222-624q-29 26-53 57t-41 67q50 101 143.5 160.5T480-280q20 0 39-2.5t39-5.5l-36-38q-11 3-21 4.5t-21 1.5q-75 0-127.5-52.5T300-500q0-11 1.5-21t4.5-21l-84-82Zm319 93Zm-151 75Z"/></svg>
                                
                                <input class="w-full h-8 pl-10 text-black rounded md:h-10 lg:h-12 md:pl-12 lg:w-96" type="password" name="password" id="password">
                            </div>
                        </div>
