<section class="fixed z-20 w-full h-auto overflow-hidden md:w-1/3 lg:w-2/12 md:relative" id="insSideCont">
    <div class="fixed w-full md:h-screen md:pt-16 top-14 md:relative md:border-r-2" id="instructorSidebar">
        <ul class="flex flex-row justify-between md:flex-col md:text-base">
            <li id="instructor_dashboard" class="w-full py-3 rounded-lg hover:bg-darthmouthgreen group md:py-4">
                <a class="flex items-center justify-center md:justify-start md:px-4 " href="{{ url('/instructor/dashboard')}}">
                    <svg id="dashboard_svg" class="mx-2 duration-500 stroke-seagreen group-hover:animate-pulse group-hover:stroke-white" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.7">
                    ...
                    <h1 id="dashboard_txt" class="hidden md:block group-hover:animate-pulse group-hover:text-white">Dashboard</h1>
                </a>
            </li>
            ...
            <li id="instructor_chats" class="w-full py-3 rounded-lg hover:bg-darthmouthgreen group md:py-4">
                <a class="flex items-center justify-center md:justify-start md:px-4" href="">
                    <svg class="mx-2 duration-500 fill-seagreen group-hover:animate-pulse group-hover:fill-white" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 class="hidden md:block group-hover:animate-pulse group-hover:text-white">Chats</h1>
                </a>
            </li>
            ...
            <li id="instructor_courses" class="w-full py-3 rounded-lg hover:bg-darthmouthgreen group md:py-4">
                <a class="flex items-center justify-center md:justify-start md:px-4" href="{{ url('/instructor/courses') }}">
                    ...
                    <svg class="mx-2 duration-500 fill-seagreen group-hover:animate-pulse group-hover:fill-white" width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 class="hidden md:block group-hover:animate-pulse group-hover:text-white">Courses</h1>
                </a>
            </li>
            ...
            <li id="instructor_performance" class="w-full py-3 rounded-lg hover:bg-darthmouthgreen group md:py-4">
                <a class="flex items-center justify-center md:justify-start md:px-4" href="">
                    ...
                    <svg class="mx-2 duration-500 fill-seagreen group-hover:animate-pulse group-hover:fill-white" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 class="hidden md:block group-hover:animate-pulse group-hover:text-white">Performance</h1>
                </a>
            </li>
            ...
            <li id="instructor_calendar" class="w-full py-3 rounded-lg hover:bg-darthmouthgreen group md:py-4">
                <a class="flex items-center justify-center md:justify-start md:px-4" href="">
                    ...
                    <svg class="mx-2 duration-500 stroke-seagreen group-hover:animate-pulse group-hover:stroke-white" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li id="instructor_settings" class="w-full py-3 rounded-lg hover:bg-darthmouthgreen group md:py-4">
                <a class="flex items-center justify-center md:justify-start md:px-4" href="{{ url('/instructor/settings') }}">
                    ...
                    <svg id="settings_svg" class="mx-2 duration-500 fill-seagreen group-hover:animate-pulse group-hover:fill-white" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 id="settings_txt" class="hidden md:block group-hover:animate-pulse group-hover:text-white">Settings</h1>
                </a>
            </li>
            ...
            <li id="instructor_profile" class="w-full py-3 rounded-lg hover:bg-darthmouthgreen group md:py-4 md:hidden">
                <a class="flex items-center justify-center md:justify-start md:px-4" href="">
                    ...
                    <svg class="mx-2 duration-500 fill-mainseagreenbg group-hover:animate-pulse" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg>

                    <h1 class="hidden group-hover:animate-pulse">Profile</h1>
                </a>
            </li>
            
            <form class="hidden mx-4 mt-10 rounded-lg bg-opacity-30 bg-seagreen md:block group hover:bg-darthmouthgreen" action="{{ url('/instructor/logout') }}" method="POST"> 
                @csrf
                <button type="submit" class="flex flex-row items-center justify-center w-full h-12 group-hover:cursor-pointer" >
                    <svg class="fill-seagreen group-hover:animate-pulse group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h280v80H200v560h280v80H200Zm440-160-55-58 102-102H360v-80h327L585-622l55-58 200 200-200 200Z"/></svg>
                    <h1 class="group-hover:animate-pulse group-hover:text-white">Logout</h1>
                </button>
            </form>
...
<script>
    ...
    if(currentUrl.includes('/instructor/dashboard')) {
        $('#instructor_dashboard').addClass('bg-darthmouthgreen');
        $('#dashboard_svg').addClass('stroke-white');
        $('#dashboard_txt').addClass('text-white');
    } else if (currentUrl.includes('/instructor/settings')) {
        $('#instructor_settings').addClass('bg-darthmouthgreen');
        $('#settings_svg').addClass('fill-white');
        $('#settings_txt').addClass('text-white');
    } else {
