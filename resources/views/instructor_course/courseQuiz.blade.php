...
<section class="main-container">
    ...
    <section class="w-full px-2 pt-[120px] mx-2 mt-2 md:w-3/4 lg:w-9/12  overscroll-auto md:overflow-auto">
        <div class="p-3 pb-4 overflow-auto rounded-lg shadow-lg overscroll-auto" id="quizMainContainer">
            ...
            <div class="flex flex-col items-center justify-center" id="containersss">
                
                {{-- <form class="flex flex-col w-4/5 p-4 mx-auto my-2 border-2 border-gray-200 rounded lg:w-2/3 lg:flex-row-reverse lg:justify-between" action="" id="identificationQuestion">
                ...
                <form class="flex flex-col w-4/5 p-4 mx-auto my-2 border-2 border-gray-200 rounded lg:w-2/3 lg:flex-row-reverse lg:justify-between" action="" id="multiChoiceQuestion">
                    <div>
                        <input class="w-full h-10 pl-2 my-2 mb-5 bg-transparent border-b-2 border-b-seagreen focus:bg-gray-200" type="text" placeholder="Question...">
                ...
                <form class="flex flex-col w-4/5 p-4 mx-auto my-2 border-2 border-gray-200 rounded lg:w-2/3 lg:flex-row-reverse lg:justify-between" action="" id="essayQuestion">
                    <div>
