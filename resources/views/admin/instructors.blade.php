...
<section id="AD002_I_maincontent" class="relative w-4/5 h-full left-80">
    ...
    <div id="AD002_I_maincontainer" class="relative max-h-full px-5 py-5 shadow-2xl bg-mainwhitebg mt-7 rounded-2xl">
        <div id="containertitle" class="flex items-center justify-between pt-1 pb-5 px-auto">
            ...
            <div class="">
                <a href="/admin/add_instructor" class="px-3 py-2 mx-3 text-lg font-medium bg-green-600 rounded-xl hover:bg-green-900 hover:text-white">Add New</a>
        ...
        <div id="AD002_I_contenttable" class="mt-7">
          <table class="">
            <thead class="border-b-2 border-black">
                <th class="w-2/12 text-xl text-left">Learner ID</th>
            ...
            <tbody class="">
                <tr class="">
                    <td class="w-2/12 py-1 text-lg font-normal">20230821001</td>
                    <td class="w-3/12 py-1 text-lg font-normal">Juan Dela Cruz</td>
                    ...
                    <td class="w-1/12"><a href="/admin/view_instructor" class="px-3 py-2 mx-3 text-lg font-medium bg-green-600 rounded-xl hover:bg-green-900 hover:text-white">view</a></td>
                </tr>
