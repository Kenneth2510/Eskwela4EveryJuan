                    ...
                    <div class="pb-4 mx-4 text-sm border-b-4">
                        ...
                        <div class="flex flex-col my-4 lg:flex-row lg:justify-between lg:items-center">
                            ...
                            <div class="relative lg:w-1/2">
                                ...
                                <input class="w-full h-8 pl-10 rounded text-darthmouthgreen md:h-10 lg:h-12 md:pl-12" type="text" name="instructor_username" id="instructor_username">
                            </div>
                            
                        </div>
                        
                        <div class="flex flex-col my-4 lg:flex-row lg:justify-between lg:items-center">
                            <label class="text-xl font-medium text-darthmouthgreen lg:w-1/2" for="instructor_password">Password:</label>
                            <div class="relative lg:w-1/2">
                                ...
                                <input class="w-full h-8 pl-10 rounded text-darthmouthgreen md:h-10 lg:h-12 md:pl-12" type="password" name="password" id="password">
                        ...
                        <div class="flex items-center justify-between px-4 my-4 md:text-base">
                            <div class="flex items-center">
                                ...
                                <label class="text-darthmouthgreen" for="">Remember me</label>
                            </div>
                            
                            {{-- <x-forms.primary-button color="amber" name="Log in" /> --}}
                            <button type="submit" name="Login" class="px-5 py-3 text-xl text-white rounded-xl bg-darthmouthgreen hover:bg-white hover:text-darthmouthgreen hover:border-darthmouthgreen hover:border-2">Login</button>
                        </div>
                    </div>
                </form>
