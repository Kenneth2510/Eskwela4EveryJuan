...
<section class="w-full pt-[125px] mx-4  overscroll-auto md:overflow-auto">
    ...
    <div class="relative z-0 pb-4 bg-black border border-gray-400 rounded-lg shadow-lg text-mainwhitebg">
        ...
        <div class="flex items-center w-full">
            @if ($isEnrolled !== null)
                <a href="{{ url("/learner/course/manage/$course->course_id/overview") }}" id="startBtn" class="w-32 h-10 px-6 py-2 m-2 rounded-full bg-seagreen hover:bg-green-800">
                    Start Now
                </a>
    ...
    <div class="relative w-full mt-5">
        ...
        <div class="flex justify-between text-mainwhitebg fill-mainwhitebg">
            <button data-course-id="{{$course->course_id}}" id="" class="relative items-center w-1/2 h-16 p-2 mr-2 text-center rounded-lg showCourseManageModal bg-darthmouthgreen">
                <h1>Manage Course</h1>
        ...
        <div class="flex flex-col pt-4">
            <div class="flex flex-row items-center py-4 my-2 bg-teal-400 rounded-lg shadow-lg justify-evenly">
                ...
                <h1 class="text-xl font-medium">90%</h1>
            </div>
